...
# lowercase words Chuyển đổi các từ thành chữ thường
def normalize(word):
...
# replace synonym word  thay thế từ đồng nghĩa
...
def give_emoji_free_text(text):
    ...
    clean_text2 = ' '.join([str for str in text.decode('utf-8').split() if not any(i in str for i in emoji_list)])
    return clean_text2
...
if __name__ == '__main__':
    ...
    print(processing("truong VKU la truong the nao",synonyms_dictionary))
